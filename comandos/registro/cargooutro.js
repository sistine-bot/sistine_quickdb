    ...
    msg.awaitReactions(filter, { max: 1, time: 60000, errors: ['time']})
      ...
      //cor rosa
        if (reaction.emoji.id === '700492893651075112') {//<:dokyerro:700492899833479249> 
          ...
          message.reply('<:dokycerto:700492893651075112> » Você definiu o cargo '+ `${lrole}`+' como o cargo de outros'); 
          db.set(`onoutro_${message.guild.id}`, 1)
          db.set(`outro_${message.guild.id}`, role)
        }
